/**
* A Script Redesigned by Mirror∆Cloud from GOIndex at https://github.com/crazy-racer/Bhadoo-Drive-Index
*/
const authConfig = {
...
const uiConfig = {
	...
	"logo_height": "99px", // only if logo_image is true
	"logo_width": "710px", // only if logo_image is true
	"logo_link_name": "<img src"images/yamraaj.png", // if logo is true then link otherwise just text for name
	"contact_link": "https://t.telegram.ind.in/BhadooCloud", // Link to Contact Button on Menu
	"copyright_year": "2050", // year of copyright, can be anything like 2015 - 2020 or just 2020
	"company_name": "yamraaj007", // Name next to copyright
